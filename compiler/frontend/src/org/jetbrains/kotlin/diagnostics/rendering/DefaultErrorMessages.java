...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(WRONG_MODIFIER_TARGET, "Modifier ''{0}'' is not applicable to ''{1}'' target", TO_STRING, TO_STRING);
        MAP.put(WRONG_MODIFIER_PARENT, "Modifier ''{0}'' is not applicable inside ''{1}''", TO_STRING, TO_STRING);
